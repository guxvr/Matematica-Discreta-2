/*
 * Questão bônus: Congruência com Inverso Modular e Exponenciação Rápida
 * Disciplina: Matemática Discreta 2
 * Autor: Gustavo Xavier Evangelista - 241025247
 */

 /* A saída com H=7, G=3, Zn=11, x=10 e n1=13 é 'Valor final da congruência: 4' */
#include <stdio.h>
...
// Inverso modular (Euclides Estendido) com passos
